...
public class ExecutionScriptTag {
  ...
  public boolean equals(Object obj) {
    ...
    if (dockerRepository == null) {
      if (other.dockerRepository != null) return false;
    } else if (!dockerRepository.equals(other.dockerRepository)) return false;
    if (dockerTag == null) {
      if (other.dockerTag != null) return false;
    } else if (!dockerTag.equals(other.dockerTag)) return false;
    if (name == null) {
    ...
    if (getMemoryUsage() == null) {
      if (other.getMemoryUsage() != null) return false;
    } else if (!getMemoryUsage().equals(other.getMemoryUsage())) return false;
    if (getCpuUsage() == null) {
      if (other.getCpuUsage() != null) return false;
    } else if (!getCpuUsage().equals(other.getCpuUsage())) return false;
    return true;
  }
}
