...
public class ExecutionScriptTagUtil {
  ...
  protected static ExecutionScriptTag findExecutionScriptTag(
      String name, String type, JSONObject jsonExecScriptTagFile) throws SapsException {
    try {
